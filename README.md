...
**Le tableau de bord qui rassemble tes vidéos YouTube, TikTok et Instagram au même endroit.**

[🌐 Voir le site](https://social-hub.fr) · [💻 Code source (branche `main`)](https://github.com/Paullux/SocialHub/tree/main) · [📖 README du projet](https://github.com/Paullux/SocialHub/blob/main/README.md)
...
<details>
<summary>🔧 Pour les développeurs — à propos de cette doc</summary>

<br>

Cette documentation vit sur une branche dédiée du dépôt, **`Documents`**, séparée du code applicatif (branche `main`). Elle est écrite en Markdown pur pour rester lisible directement sur GitHub, sans dépendance à un générateur de site statique.

- Code applicatif : [`main`](https://github.com/Paullux/SocialHub/tree/main)
- Cette doc : [`Documents`](https://github.com/Paullux/SocialHub/tree/Documents)

Pour la mettre à jour : `git checkout Documents` (ou un `git worktree` dédié), éditer les fichiers `.md`, commit, push.
