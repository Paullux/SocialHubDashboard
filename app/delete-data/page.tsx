  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <div className="legal-prose mt-4">
        ...
        <ul>
          <li>
            les <strong>jetons d’accès</strong> aux API des plateformes que vous connectez,
            <strong> chiffrés</strong> au repos (AES-256-GCM)&nbsp;;
          </li>
          <li>
            l’identifiant et le nom du compte connecté, les autorisations accordées&nbsp;;
          </li>
          <li>
            des <strong>instantanés horaires</strong> d’indicateurs publics (vues,
        ...
        <p>
          ...
          Facebook ou Instagram. Dans les deux cas, les <strong>jetons correspondants et le
          lien de compte sont supprimés immédiatement</strong> de nos serveurs&nbsp;; nous
        ...
        <p>
          ...
          <a href="mailto:paulwoisard@gmail.com">paulwoisard@gmail.com</a> depuis l’adresse
          associée à votre compte, ou en indiquant l’identifiant du compte concerné. La
