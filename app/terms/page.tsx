    ...
    <>
      ...
      <ul>
        ...
        <li>
          ...
          données hébergées dans la région AWS eu-central-1 (Francfort, UE) —{" "}
          <a href="https://neon.tech/privacy-policy">neon.tech/privacy-policy</a>.
        </li>
        <li>
    ...
    <>
      ...
      <ul>
        ...
        <li>
          ...
          in the AWS eu-central-1 region (Frankfurt, EU) —{" "}
          <a href="https://neon.tech/privacy-policy">neon.tech/privacy-policy</a>.
        </li>
        <li>
