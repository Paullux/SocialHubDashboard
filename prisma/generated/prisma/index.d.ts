...
export namespace Prisma {
  ...
  */
  ...
  export type OAuthTokenOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"provider" | "userId" | "openId" | "accessToken" | "refreshToken" | "scope" | "expiresAt" | "updatedAt", ExtArgs["result"]["oAuthToken"]>
  ...
  export interface OAuthTokenDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const oAuthTokenWithProviderOnly = await prisma.oAuthToken.findMany({ select: { provider: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many OAuthTokens and only return the `provider`
     * const oAuthTokenWithProviderOnly = await prisma.oAuthToken.createManyAndReturn({
     ...
     * })
     * 
     * // Update zero or more OAuthTokens and only return the `provider`
     * const oAuthTokenWithProviderOnly = await prisma.oAuthToken.updateManyAndReturn({
     *   select: { provider: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface OAuthTokenFieldRefs {
    ...
    readonly openId: FieldRef<"OAuthToken", 'String'>
    ...
    readonly expiresAt: FieldRef<"OAuthToken", 'BigInt'>
  ...
  export type OAuthTokenWhereInput = {
    ...
    openId?: StringFilter<"OAuthToken"> | string
    ...
    expiresAt?: BigIntFilter<"OAuthToken"> | bigint | number
  ...
  export type OAuthTokenScalarWhereWithAggregatesInput = {
    ...
    openId?: StringWithAggregatesFilter<"OAuthToken"> | string
    ...
    expiresAt?: BigIntWithAggregatesFilter<"OAuthToken"> | bigint | number
